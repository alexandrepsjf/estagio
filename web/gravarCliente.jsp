...
<html>
    ...
    <body> 
        ...
        <form action="FrontController?action=GravarCliente" method="post" class="form-inline">
            <div class="form-group col-md-3 mb-">
                <label for="textNome"></label>
                <input type="text" class="form-control" id="textNome" name="textNome"  placeholder="Nome">
            </div>
            <div class="form-group col-3">
                <label for="textCidade"></label>
                <input type="text" class="form-control" id="textCidade" name="textCidade" placeholder="Cidade">
            </div>
            <div class="form- col-2">
                <label for="textData"></label>
                <input type="date" class="form-control" id="textData" name="textData"  placeholder="Data">
            </div>
